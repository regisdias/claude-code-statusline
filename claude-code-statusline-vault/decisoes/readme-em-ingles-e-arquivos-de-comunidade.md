...
- **Os rótulos da statusline** (`semana`, `sessão`, `reseta`). Mudar isso quebra a saída de quem já
  instalou e obriga a mexer nas duas implementações. É uma decisão em aberto, não um esquecimento —
  veja [[pendentes/2026-09-12-rotulos-da-barra-em-portugues]].
